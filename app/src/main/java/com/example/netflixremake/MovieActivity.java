...
public class MovieActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtDesc.setText("Titans acompanha um grupo de jovens e futuros super-heróis do universo DC. Na série, Dick Grayson (Brenton Thwaites) surge das sombras para se tornar o líder de uma equipe destemida de novos heróis que inclui Estelar (Anna Diop), Raven (Teagan Croft), entre outros.");
